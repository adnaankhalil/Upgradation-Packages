FOR /R "C:\Program Files (x86)\Apache Software Foundation\CouchDB\var\lib\couchdb" %%F in (*.*) do %~dp0\Bell-Installer-for-Windows\curl -X DELETE http://oleifo:oleole@localhost:5984/%%~nF
